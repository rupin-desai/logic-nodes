...
const CTA = () => {
  ...
  return (
    <section className="relative py-24 overflow-hidden bg-gradient-to-br from-[#282B4C] via-[#1a1d35] to-[#282B4C]">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-gradient-to-r from-[#25B8F2]/20 to-[#EF5BB7]/20 border border-[#25B8F2]/30 mb-6"
          >
          ...
          >
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className="group relative px-8 py-4 bg-gradient-to-r from-[#25B8F2] to-[#EF5BB7] rounded-full font-bold text-white text-lg shadow-lg hover:shadow-[#25B8F2]/50 transition-all duration-300 overflow-hidden"
            >
              ...
              <motion.div
                className="absolute inset-0 bg-gradient-to-r from-[#EF5BB7] to-[#25B8F2]"
                initial={{ x: "100%" }}
                whileHover={{ x: 0 }}
